...
//	ICM_20948_gyroBandwidthSet(ICM_20948_GYRO_BW_6HZ);
//	ICM_20948_accelBandwidthSet(ICM_20948_ACCEL_BW_6HZ);
...
/**************************************************************************//**
 * @brief
 *   Enables the necessary SPI interface to communicate with the IMU
 *
 * @warning
 *   "WARN: " There is still a problem with IMU power consumption
 *
 * @note
...
/**************************************************************************//**
 * @brief
 *   Turns the GPIO pin high to provide power to the IMU
 *
 * @note
...
void ICM_20948_power (bool enable)
{
	...
	{
		if (enable) GPIO_PinOutSet(ICM_20948_POWER_PORT, ICM_20948_POWER_PIN); /* Enable VDD pin */
		else GPIO_PinOutClear(ICM_20948_POWER_PORT, ICM_20948_POWER_PIN); /* Disable VDD pin */
	}
}
...
void ICM_20948_registerWrite(uint16_t addr, uint8_t data)
{
	...
	ICM_20948_bankSelect(bank); // TODO
